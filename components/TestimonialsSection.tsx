...
const StarIcon = ({ color }: { color: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill={color} className="w-4 h-4 md:w-5 md:h-5">
    ...
    <section className="w-full bg-white py-24 px-6 md:px-12 font-sans border-t border-[#E5E5E5]">
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div className="relative flex flex-col justify-between p-8 border border-[#E5E5E5] bg-white min-h-[500px] xl:min-h-[600px]">
           ...
           <div className="absolute top-8 right-8 w-2.5 h-2.5 border-t-2 border-r-2 border-[#F9452D]"></div>
        ...
        <div className="relative flex flex-col justify-end p-8 min-h-[500px] xl:min-h-[600px] group overflow-hidden bg-gray-900">
            ...
            <div className="absolute inset-0 z-0">
               ...
               <div className="absolute inset-0 bg-gradient-to-t from-[#F9452D]/90 via-[#F9452D]/40 to-transparent opacity-90"></div>
            </div>
        ...
        <div className="relative flex flex-col justify-between p-8 bg-[#0C0C0C] min-h-[500px] xl:min-h-[600px]">
             <div className="flex flex-col h-full justify-between">
                 <div>
                    {/* Stars */}
                    <div className="flex gap-1 text-[#F9452D] mb-8">
