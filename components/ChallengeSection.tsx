            ...
            <div className="max-w-[1600px] mx-auto relative z-10">
                ...
                >
                    <div className="flex flex-col max-w-5xl relative z-10">
                        ...
                        <p className="text-3xl md:text-4xl lg:text-[3.5rem] font-medium text-black leading-[1.2] lg:leading-[1.05] tracking-tight max-w-4xl">
                    ...
                    <div className="flex flex-col xl:items-end w-full max-w-lg xl:text-right gap-6 mt-12 xl:mt-0 pb-4 relative z-10">
                        ...
                        <p className="text-xl md:text-2xl font-medium text-black/70 leading-[1.4] pr-2 xl:pr-0">
