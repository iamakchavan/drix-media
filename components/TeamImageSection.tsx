          ...
          <div className="flex flex-col w-full mt-auto">
             ...
             <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-12 lg:gap-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24 w-full lg:w-auto">
                   {stats.map((stat, i) => (
                      <div key={i} className="flex flex-col relative pt-2">
                         {/* Red Corner Accent */}
                         <div className="absolute top-0 left-0 w-2.5 h-2.5 border-r-2 border-b-2 border-[#F9452D] transform -rotate-90"></div>
                ...
                <a href="#" className="flex items-center gap-4 group mt-4 lg:mt-0 shrink-0">
                   <div className="w-12 h-12 flex items-center justify-center text-[#F9452D] transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1">
