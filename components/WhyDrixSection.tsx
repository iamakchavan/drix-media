    ...
    <section className="w-full bg-[#FAFAFA] py-24 px-4 md:px-8">
      ...
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-200 p-10 md:p-12 flex flex-col justify-between min-h-[400px] relative overflow-hidden group hover:border-gray-300 transition-colors duration-300">
          ...
          {/* Icon */}
          <div className="mb-8">
            <div className="w-16 h-16 flex items-center justify-center text-[#476D07]">
        ...
        <div className="bg-black p-10 md:p-12 flex flex-col justify-between min-h-[400px] relative overflow-hidden group">
          ...
          {/* Number Badge */}
          <div className="absolute top-8 right-8 w-12 h-12 rounded-full bg-[#AFFF00] text-black flex items-center justify-center text-lg font-bold shadow-[0_0_30px_rgba(175,255,0,0.4)]">
            02
          </div>
        ...
        <div className="bg-[#AFFF00] p-10 md:p-12 flex flex-col justify-between min-h-[400px] relative overflow-hidden group">
          {/* Decorative Circle */}
          <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-black/5 blur-3xl"></div>
          ...
          {/* Icon - Using darker green for contrast in this specific non-major spot */}
          <div className="mb-8 relative z-10">
            <div className="w-16 h-16 flex items-center justify-center text-[#094B28]">
              <svg width="48" height="48" viewBox="0 0 256 256" fill="currentColor">
