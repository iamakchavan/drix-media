                ...
                <div className="relative">
                     ...
                     <div className="flex flex-col gap-2">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute -left-3 top-1 w-2.5 h-2.5 border-r-2 border-b-2 border-[#F9452D] transform -rotate-90"></div>
            ...
            {/* Mobile Header */}
             <div className="flex md:hidden items-center justify-between mb-16">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="w-2 h-2 border-r-2 border-b-2 border-[#F9452D]"></div>
                </div>
             </div>
                ...
                <div className="w-full md:w-7/12 flex flex-col pt-0 md:pt-32">
                                 ...
                                 >
                                    <div className="flex flex-col md:flex-row md:items-baseline gap-2 md:gap-4 w-full relative">
                                        ...
                                        <div className="flex items-baseline font-bold tracking-[-0.05em] text-lg md:text-xl md:ml-4 align-top -mt-2 md:mt-0 absolute md:static top-0 right-0">
                                            <span className={`transition-colors duration-300 ${isActive ? 'text-[#F9452D]' : 'text-white/20'}`}>{'{'}</span>
                     ...
                     <div className="mt-16 md:mt-24">
                         <a href="#" className="inline-flex items-center gap-4 group">
                             ...
                             <div className="w-8 h-8 text-[#F9452D] transition-transform duration-300 group-hover:translate-x-1 group-hover:translate-y-1">
