    ...
    <footer id="footer" className="w-full min-h-screen bg-[#050505] text-white pt-16 md:pt-20 poppins-regular overflow-x-hidden flex flex-col relative selection:bg-[#AFFF00] selection:text-black">
      <div className="max-w-[1600px] mx-auto w-full px-6 md:px-12 flex-grow flex flex-col justify-between relative z-10 pb-8 md:pb-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:gap-0 mt-4">
          ...
          {/* 1. Logo & Contact — left */}
          <div className="w-full md:w-1/3 flex flex-col gap-6 pt-2">
            ...
            <div className="flex items-center gap-5 mt-2">
              <Link to="/privacy" className="text-[10px] poppins-medium tracking-[0.12em] uppercase text-white/20 hover:text-white/50 transition-colors duration-300">Privacy</Link>
              <Link to="/terms" className="text-[10px] poppins-medium tracking-[0.12em] uppercase text-white/20 hover:text-white/50 transition-colors duration-300">Terms</Link>
              <Link to="/cookies" className="text-[10px] poppins-medium tracking-[0.12em] uppercase text-white/20 hover:text-white/50 transition-colors duration-300">Cookies</Link>
            </div>
          </div>

          {/* 2. Nav links — center */}
          <div className="w-full md:w-1/3 flex flex-col items-start md:items-center relative pt-6">
        ...
        {/* GET IN TOUCH CTA */}
        <div className="w-full flex justify-center items-end flex-1 pb-8 md:pb-12 pointer-events-none z-10 overflow-visible">
              ...
              <div className="flex items-center gap-3 md:gap-5 justify-center">
                ...
                >
                  <motion.svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="butt" strokeLinejoin="miter"
                    className="w-20 h-20 sm:w-24 sm:h-24 md:w-36 md:h-36 lg:w-44 lg:h-44 text-[#AFFF00]"
