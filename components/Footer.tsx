...
const Footer: React.FC = () => {
   return (
      <footer id="footer" className="w-full min-h-screen bg-[#050505] text-white pt-16 md:pt-20 poppins-regular overflow-x-hidden flex flex-col relative selection:bg-[#AFFF00] selection:text-black">

         <div className="max-w-[1600px] mx-auto w-full px-6 md:px-12 flex-grow flex flex-col justify-between relative z-10">
            
            {/* TOP BAR: Nav, Logo+Contact, Social */}
            <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:gap-0 mt-4">
                
                {/* 1. Page Links — left */}
                <div className="w-full md:w-1/3 flex flex-col items-start relative pt-6">
                    <span className="absolute left-0 top-0 text-white/20 w-4 h-4 flex items-center justify-center font-light text-xl">+</span>
                    <div className="w-fit grid grid-cols-2 gap-x-10 gap-y-3 md:gap-y-4">
                        {[
                            { label: 'Home', path: '/' },
                            ...
                            >
                                <Link to={path} className="opacity-0 pointer-events-nxt-base md:text-lg poppins-semibold">{label}</Link>
                ...
                {/* 2. Logo & Contact — centered */}
                <div className="w-full md:w-1/3 flex flex-col items-center gap-6 pt-2">
                    <div className="flex items-start select-none w-fit">
                    ...
                    <div className="flex flex-col items-center gap-1 text-center">
                        <span className="text-xs font-bold text-white/25 tracking-widest uppercase">Get in touch</span>
                ...
                {/* 3. Social — right */}
                <div className="w-full md:w-1/3 flex flex-col items-start md:items-end relative pt-6">
                    ...
                    <div className="w-fit grid grid-cols-2 gap-x-10 gap-y-3 md:gap-y-4 md:mr-6">
                        {[
            ...
            {/* GET IN TOUCH CTA */}
            <div className="w-full flex justify-center items-center pt-10 md:pt-14 pb-8 md:pb-10 pointer-events-none z-10 flex-col overflow-visible mt-10 md:mt-14">
                <div className="w-full flex justify-center relative items-center">
                    ...
                    >
                        <motion.span 
                            ...
                            className="text-[18vw] md:text-[13vw] leading-[0.85] w-full text-center md:pl-[3vw] transition-colors duration-700 ease-out"
                        >
                            GET IN
                        </motion.span>
                        <div className="flex items-center gap-3 md:gap-5 justify-center">
                            <motion.span 
                                ...
                                className="text-[18vw] md:text-[13vw] leading-[0.85] transition-colors duration-700 ease-out"
                            >
                                TOUCH
                            </motion.span>
                            <motion.div 
                                ...
                                className="flex items-center justify-center flex-shrink-0 mt-1 md:mt-3"
                            >
                                <motion.svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="butt" strokeLinejoin="miter" className="w-12 h-12 sm:w-16 sm:h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 text-[#AFFF00]"
                                  variants={{
         ...
         <div className="border-t border-white/[0.06] mt-4">
            <div className="max-w-[1600px] mx-auto w-full px-6 md:px-12 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
               <span className="text-[10px] poppins-medium tracking-[0.15em] uppercase text-white/15">
                  © {new Date().getFullYear()} Drix Media. All rights reserved.
               </span>
               <div className="flex items-center gap-6">
                  <Link to="/privacy" className="text-[10px] poppins-medium tracking-[0.12em] uppercase text-white/20 hover:text-white/50 transition-colors duration-300">
                     Privacy
                  </Link>
                  <Link to="/terms" className="text-[10px] poppins-medium tracking-[0.12em] uppercase text-white/20 hover:text-white/50 transition-colors duration-300">
                     Terms
                  </Link>
                  <Link to="/cookies" className="text-[10px] poppins-medium tracking-[0.12em] uppercase text-white/20 hover:text-white/50 transition-colors duration-300">
                     Cookies
                  </Link>
               </div>
            </div>
