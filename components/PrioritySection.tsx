...
const CheckItem = ({ text, checked }: { text: string, checked?: boolean }) => (
    <li className="flex items-center gap-3">
        {checked ? (
            <div className="w-[18px] h-[18px] rounded-full bg-[#588B00] flex items-center justify-center shrink-0">
                <svg width="10" height="8" viewBox="0 0 8 6" fill="white"><path d="M2.5 6L0 3.5L0.71 2.79L2.5 4.58L7.29 0L8 0.71L2.5 6Z" /></svg>
            </div>
        ) : (
        ...
        <section id="benefits" className="w-full bg-white py-16 md:py-20 px-4 md:px-8">
            ...
            <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <div className="bg-[#F5F5F5] p-8 flex flex-col h-[540px] relative overflow-hidden">
                    {/* Red accent corner */}
                    <div className="absolute top-6 right-6 text-[#588B00]">
                ...
                <div className="bg-[#0A0A0A] p-8 flex flex-col justify-between h-[540px] relative overflow-hidden">
                    ...
                    <div className="relative z-10 text-center w-full mt-8 flex flex-col items-center">
                        ...
                        {/* Red Circle Button */}
                        <div className="w-[85px] h-[85px] mx-auto bg-[#AFFF00] rounded-full flex items-center justify-center relative shadow-[0_0_40px_rgba(249,69,45,0.3)] group cursor-pointer hover:scale-105 transition-transform duration-300">
                            <div className="absolute -top-1 right-0 bg-white text-[#AFFF00] text-[12px] font-semibold w-5 h-5 rounded-full flex items-center justify-center">6</div>
