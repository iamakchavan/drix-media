...
const PricingSection: React.FC = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      isHighlight: true,
      badge: { text: "Most popular", bg: "bg-[#F9452D]/10", textCol: "text-[#F9452D]", icon: "fire" }
    },
    {
      name: "Max",
      price: 3999,
    ...
    <section id="pricing" className="w-full bg-[#F5F5F5] py-24 px-4 md:px-8 text-[#0C0C0C] font-sans">
       ...
       <div className="flex items-center justify-center gap-4 mb-20 select-none">
          ...
          <button 
            ...
            className="w-[50px] h-[30px] bg-[#F9452D] rounded-full p-[3px] relative transition-colors duration-300 focus:outline-none cursor-pointer"
          >
          ...
          <div className="bg-[#F9452D]/10 text-[#F9452D] text-xs font-bold px-3 py-1.5 rounded-full ml-1">
             Save 30%
          </div>
       </div>
             ...
             >
                ...
                {plan.isHighlight && (
                   <div className="absolute top-0 right-0 p-4">
                       <div className="w-3 h-3 border-t-[2px] border-r-[2px] border-[#F9452D]"></div>
                   </div>
                )}
                ...
                <a href="#" className={`
                    ...
                    ${plan.isHighlight ? 'bg-[#F9452D] text-white shadow-lg' : 'bg-white text-[#0C0C0C]'}
                `}>
                   {/* Icon */}
                   <div className={`w-5 h-5 ${plan.isHighlight ? 'text-white' : 'text-[#F9452D]'}`}>
                ...
                <div className="flex flex-col gap-3">
                   {plan.features.map((feature, i) => (
                      <div key={i} className="flex items-start gap-3">
                         ...
                         <div className="w-2.5 h-2.5 border-t-[2px] border-l-[2px] border-[#F9452D] mt-1.5 shrink-0"></div>
