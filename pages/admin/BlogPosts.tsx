      ...
      <div className="px-6 md:px-10 py-10 flex flex-col gap-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-white/25 text-[12px] mt-1">{blogPosts.length} posts total</p>
          </div>
          ...
          <AnimatePresence>
            {filtered.length === 0 ? (
              ...
              >
                ...
                <span className="text-[12px] text-white/30">{post.author}</span>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.95, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.95 }}
              ...
              <div>
                ...
                <p className="text-white/30 text-[13px] mt-2">This action cannot be undone once Supabase is connected.</p>
              </div>
