...
const CareersHero = () => (
    <SharedHeroLayout 
            ...
            <>
                ...
                <div className="flex flex-wrap items-center overflow-visible mt-1 md:mt-2 pb-2 md:pb-4 gap-x-[1vw] md:gap-x-4">
                    <span className="flex text-[#AFFF00]">
                        {"At Drix Media.".split('').map((char, index) => (
        ...
        subtextContent={
            <>
                <span className="text-white font-semibold block xl:whitespace-nowrap">We are looking for strategists, designers, writers, and thinkers</span>
                <span className="block xl:whitespace-nowrap">who want to do work that actually matters.</span>
            </>
        }
    />
);
